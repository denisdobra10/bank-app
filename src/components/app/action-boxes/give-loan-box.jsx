            ...
            <form className='flex flex-row gap-4 items-center'>
                ...
                <div className="flex flex-row gap-2">
                    <div className="flex flex-col gap-2 items-center">
                        <input type="text" name='giveLoanAmount' id='giveLoanAmount' placeholder='Suma inapoiata' className='text-paragraph text-center px-2 py-1 bg-opacity-35 bg-white rounded-lg focus:outline-none' />
                    </div>
                </div>
